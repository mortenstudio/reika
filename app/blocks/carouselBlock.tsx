...
function CarouselSlideCard({
  ...
  return (
    <article className="flex min-w-[min(85vw,60rem)] shrink-0 flex-col gap-4">
      ...
      {(slide.title || slide.description) && (
        <div className="flex max-w-2xl flex-col gap-2 bg-white py-2">
          {slide.title ? (
...
function CarouselSlides({ slides }: CarouselSlidesProps) {
  ...
  return (
    <div className="col-span-6 md:col-span-12">
      <div
        ref={emblaRef}
        className="cursor-grab overflow-hidden active:cursor-grabbing bg-white py-4"
...
export default function CarouselBlock({ data }: CarouselBlockProps) {
  ...
  return (
    <section>
      <div className="grid grid-cols-6 md:grid-cols-12 gap-8 my-30 md:my-60">
